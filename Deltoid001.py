...
# Deltoid Curve parameters
R = random.uniform(100, 300)  # Random radius of the generating circle

# Function to compute Deltoid curve coordinates
def deltoid_curve(t):
...
for i in range(t_max):
    ...
    # Display the frame
    cv2.imshow('Deltoid Curve', frame)
